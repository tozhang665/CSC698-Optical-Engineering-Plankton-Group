...
OBJECT_ARRAY_FILE_NAME = '9am_holo_features.csv'
...
header = 'image,trackID,cluster,clusterReject,class,classReject,x0,y0,x1,y1,xc,yc,trackDistance,deltaArea,speed,area,aspectRatio,texture,solidity,eMajor,eMinor,contourLen,perimeter,radius,mean,std'

# detection and feature column pointers
IMCOUNT = 0; TRACK_ID = 1; CLUSTER = 2; CLUSTER_REJECT = 3; CLASS = 4; CLASS_REJECT = 5; X0 = 6; Y0 = 7; 

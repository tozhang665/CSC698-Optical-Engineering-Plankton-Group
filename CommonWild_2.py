# User defined files
FOLDER = '/users/anthonybravo/Desktop/SFSU/CSC667_opticalEngineering/video/merced'
VID_FILE_NAME = r'planktonVariety.mp4'
OBJECT_ARRAY_FILE_NAME = 'test.csv'


# Video processing
MAX_FRAME = 200    	  # # dil species starts at frame 742 (this will be the new 0) and ends at after frame 1012. this makes a total of 271 frames to process. number of frames to process, make really big to process entire movie
START_FRAME = 50
